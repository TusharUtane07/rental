					...
					<div className="grid lg:grid-cols-2 grid-cols-1 gap-x-16 xl:gap-x-24 gap-y-14 max-w-lg md:max-w-3xl lg:max-w-full mx-auto">
						<div>
							...
							<div className="my-12 grid md:grid-cols-2 grid-cols-1 md:gap-x-8 gap-y-8">
								<div className="rounded-2xl border border-gray-200 bg-white p-7 group transition-all duration-500 hover:bg-gray-600">
									<p className="w-14 h-14 bg-gray-600 rounded-full flex items-center justify-center mb-5 transition-all duration-500 group-hover:bg-white cursor-pointer">
										<svg
											className="fill-white transition-all duration-500 group-hover:fill-gray-600"
											width={30}
											height={30}
											viewBox="0 0 30 30"
											fill="none"
									...
									<p className="text-gray-500 text-sm font-normal leading-5 transition-all duration-500 group-hover:text-white">
										We Provide Various Methods For You To Carry Out All Car
								...
								<div className="rounded-2xl border border-gray-200 bg-white p-7 group transition-all duration-500 hover:bg-gray-600">
									<p className="w-14 h-14 bg-gray-600 rounded-full flex items-center justify-center mb-5 transition-all duration-500 group-hover:bg-white cursor-pointer">
										<svg
											className="stroke-white transition-all duration-500 group-hover:stroke-gray-600"
											width={30}
											height={30}
											viewBox="0 0 30 30"
											fill="none"
									...
									<p className="text-gray-500 text-sm font-normal leading-5 transition-all duration-500 group-hover:text-white">
										We use the latest security measures to ensure the safety of
										our customer&apos;s information in every step of their
										rental journey.
									</p>
								</div>
							</div>
						...
						<form className="h-fit bg-white border border-slate-200 rounded-2xl lg:p-12 p-8 w-full max-w-lg md:max-w-3xl lg:max-w-full mx-auto">
							...
							<button className="w-full h-12 rounded-full bg-gray-600 hover:bg-gray-900 transition-all duration-700 shadow-sm text-white text-base font-semibold leading-6 flex items-center justify-center">
								Send message{" "}
								<svg
									width={20}
									height={20}
